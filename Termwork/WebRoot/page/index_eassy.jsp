	...
	<div id="box-left">
			 		...
			 		<c:choose>
	          		...
	          		<div id="person-info">
						...
						<div id="person-content">
			            	<a href="page/eassy.jsp?eassyid=<c:out value="${row.eassyid}"/>"><div id="eassy-name"><c:out value="${row.eassytitle }"></c:out></div></a>
     ...
     <div id="box-right">
      <div id="type-box" class="items">
        <div id="type">
          <a href="page/index_eassy_design.html">架构设计</a>
        </div>
        <div id="type">
          <a href="page/index_eassy_language.html">编程语言</a>
        </div>
        <div id="type">
          <a href="page/index_eassy_web.html">WEB前端</a>
        </div>
        <div id="type">
          <a href="page/index_eassy_mobile.html">移动开发</a>
        </div>
        <div id="type">
          <a href="page/index_eassy_cloud.html">云计算</a>
        </div>


        <div id="type">
          <a href="index_eassy_internet.html">互联网</a>
        </div>
        <div id="type">
          <a href="index_eassy_SQL.html">数据库</a>
        </div>
        <div id="type">
          <a href="index_eassy_control.html">研发管理</a>
        </div>
      </div>
        <div id="person-box">
          <div id="person-rec">
            <div id="person-head"><img src="img/img/cat1.jpg" style="width: 100%;"> </div>
